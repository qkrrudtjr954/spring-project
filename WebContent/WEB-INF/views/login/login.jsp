		...
		<div id="content_wrap">
			...
			<div style="width: 502px; height: 166px; margin-left: auto; margin-right: auto; position: relative; top: 100px;">
				<div class="login_title_warp">
					<div style="margin-top: 12px;"><h2>홈페이지 제목</h2></div>
				</div>
				...
				<div id="login_wrap">
					...
					<table class="content_table" style="width: 75%;">
						...
						<tr>
							...
							<td>&nbsp;<input type="text" id="_userid" name="id" data-msg="ID를" size="15" title="아이디" style="border: 1px solid #dddddd;">
								<input type="checkbox" id="_chk_save_id">ID저장								
							</td>
						</tr>
						<tr>
							<th style="background-color: #eeeeee; color: #3e5fba;">패스워드</th>
							<td>&nbsp;<input type="password" id="_pwd" name="pwd" data-msg="패스워드를" size="15" title="패스워드" style="border: 1px solid #dddddd;">
							</td>						
						</tr>	
						<tr>
